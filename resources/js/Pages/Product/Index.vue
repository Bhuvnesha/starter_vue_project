...
<Link href="/products/create" class="bg-blue-600 text-white px-4 py-2 rounded">+ Create</Link>
...
<td class="flex gap-2">
<!-- <Link :href="\`/products/${item.id}/edit\`" class="text-blue-600">Edit</Link> -->
<button @click="router.delete('/products/'+item.id)" class="text-red-600">Delete</button>
</td>
</tr>
</tbody>
</table>
